CREATE procedure [dbo].[GetExpExpense]( 
@year int , 
@month int , 
@isfixed  bit = null , 
@isin bit = 0,
...
WHERE     (@isin is null or  ExpenseType.IsIn = @isin)
OPEN expenseCur
...
insert into @tempTable2 exec GetExpectedExpensePoInvoices  @DaysNos, @year,@month
--select * from (  
