...
-- =============================================
CREATE PROCEDURE [dbo].[UpdateCompanyBranches]
            @OldID int 
	...
	AS
BEGIN
UPDATE [dbo].[CompanyBranches]
   SET [BranchNameFL] = @BranchNameFL
      ,[BranchNameSL] = @BranchNameSL
      ,[StreetFL] = @StreetFL
      ,[StateFL] = @StateFL
      ,[CityFL] = @CityFL
      ,[CountryFL] = @CountryFL
