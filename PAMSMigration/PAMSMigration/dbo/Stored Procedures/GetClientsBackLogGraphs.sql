...
-- =============================================
CREATE PROCEDURE [dbo].[GetClientsBackLogGraphs]
...
Begin
   ...
   set @d= @FromDate 
	...
	Begin 
		 insert into #AllDatesRange 
		        values (Convert(nvarchar(5),Year(@d),100),@d,DATEADD(year,1,@d))
...
DEALLOCATE db_cursor 
	...
	IsNull(StatusCount,0) StatusCount , #AllDatesRange.DateRange as SelecetdDate,ISNull(ProductTypeID,0) ProductTypeID
	 from 
